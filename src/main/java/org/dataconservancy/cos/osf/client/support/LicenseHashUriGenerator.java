...
public class LicenseHashUriGenerator implements BiFunction<NodeBase, License, String> {
    ...
    public String apply(NodeBase nodeBase, License license) {
        String uri = String.format(uriTemplate, nodeBase.getId(), String.valueOf(ID.getAndIncrement()));
        System.err.println("Generating License Hash URI '" + uri + "'");
        return uri;
    }
